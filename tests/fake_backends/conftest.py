...
def create_chip_sample(linear_architecture_3q):
    ...
    def chip_sample(**kwargs):
        chip_sample_contents = {
                    ...
                    "one_qubit_gate_depolarization_rates": {"phased_rx": {'QB1': 0.0001, 'QB2': 0.0001, 'QB3': 0}},
                    "two_qubit_gate_depolarization_rates": {"cz": {("QB1", "QB2"): 0.001, ("QB2", "QB3"): 0.001}},
                    "one_qubit_gate_durations": {"phased_rx": 1.0},

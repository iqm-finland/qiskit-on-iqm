...
**See the latest documentation at** `<https://docs.iqm.tech/iqm-client/user_guide_qiskit.html>`_ **for more
information. The source code is available as part of the** ``iqm-client`` **package and a public mirror of the source
code is available at** `<https://github.com/iqm-finland/sdk>`_. **For support, you can contact support@iqm.tech**.

`Qiskit <https://qiskit.org/>`_ adapter for `IQM's <https://www.iqm.tech>`_ quantum computers.
